//
//  ChallengerContentDataManager.swift
//  Profess
//
...
class ChallengerContentDataManager {
    func ChallengerContentDataManager(_ viewController: ChallengerHomeViewController) {
        ...
        AF.request("http://192.168.8.191:8080/api/challenge", method: .get).validate().responseDecodable(of: CheckChallengeContentModel.self, decoder: dateDecoder) { response in
            ...
            case .success(let result):
                viewController.successAPI2(result)
                print("성공")
